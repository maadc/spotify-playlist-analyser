...
@section('content')
    ...
    <p>Personal data (usually referred to just as "data" below) will only be processed by us to the extent necessary and
        ...
        offered there.</p>
    <p>Per Art. 4 No. 1 of Regulation (EU) 2016/679, i.e. the General Data Protection Regulation (hereinafter referred
    ...
    <p>Markus Schranz<br>St. Veit 60<br>91785 Pleinfeld<br>Germany</p>
    <p>E-Mail: <a href="mailto:info@markusschranz.de">info@markusschranz.de</a></p>
    ...
    <p>For technical reasons, the following data sent by your internet browser to us or to our server provider will be
        ...
        visited, the date and time of your visit, as well as the IP address from which you visited our site.</p>
